...
export default function Home() {
  ...
  return (
    <div className="h-[100vh] border border-red-500 w-[100vw] flex flex-col justify-center items-center">
      <form
        className=" h-[20rem] w-[20rem] flex flex-col justify-center items-center gap-4"
      ...
      >
        <div className="w-full flex flex-col gap-3">
          ...
          <Input
            type="text"
            className="w-full focus-visible:ring-transparent text-black"
            value={videoLink}
            onChange={(e) => {
        ...
        <div className="flex gap-4 items-center">
          ...
          {isLoading ? (
            <Loader2 className="h-5 w-5 text-black animate-spin mt-2" />
          ) : (
